...
def new
	@words_in_mistake = @sentence.words_in_mistakes.build 
end
...
def create
  ...
  @words_in_mistake.sentence_id = @sentence.id
   ...
   if @words_in_mistake.save
       redirect_to essay_paragraph_path
    end
...
def update
 ...
 def destroy 
    ...
    respond_to do |format|
      format.html { redirect_to essay_paragraph_path(@essay, @paragraph), notice: 'Mistake was successfully destroyed.' }
